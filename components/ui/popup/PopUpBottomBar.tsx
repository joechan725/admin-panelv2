...
const PopUpBottomBar = ({
  children,
  scrollbar,
  roundedClassName = 'rounded-t-lg',
  sizeClassName = 'size-full max-h-36',
  className,
  ring = 'slate',
  ...
  return createPortal(
    <div className="fixed w-screen h-screen inset-0 flex justify-center items-end z-[99]">
      {/* Backdrop */}
      <motion.div
