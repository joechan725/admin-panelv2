...
interface AddressSelectorItemSkeletonProps {}

const AddressSelectorItemSkeleton = ({}: AddressSelectorItemSkeletonProps) => {
  return (
...
export default AddressSelectorItemSkeleton;
