...
interface DeliveryOptionSelectorItemSkeletonProps {}

const DeliveryOptionSelectorItemSkeleton = ({}: DeliveryOptionSelectorItemSkeletonProps) => {
  return (
...
export default DeliveryOptionSelectorItemSkeleton;
