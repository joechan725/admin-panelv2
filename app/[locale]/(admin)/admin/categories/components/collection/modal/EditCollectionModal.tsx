...
import LoadEditCollectionForm from '../form/LoadEditCollectionForm';

interface EditCollectionModalProps {}

const EditCollectionModal = ({}: EditCollectionModalProps) => {
    ...
    <AnimatePresence>
      {isShow && (
        <PopUpRightBar
          ...
          closeButton
        >
          <LoadEditCollectionForm onSuccess={handleBack} />
        </PopUpRightBar>
      )}
    </AnimatePresence>
  );
