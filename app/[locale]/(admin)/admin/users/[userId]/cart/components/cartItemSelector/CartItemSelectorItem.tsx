...
interface CartItemSelectorItemProps {
  setCartItems: React.Dispatch<React.SetStateAction<CartItem[]>>;
  product: Product;
  disabled: boolean;
}

const CartItemSelectorItem = ({ setCartItems, product, disabled }: CartItemSelectorItemProps) => {
  ...
  return (
    <tr className="border-b border-slate-900/10 even:bg-gray-50/50">
      ...
      {/* action */}
      <td className="p-2">
        <IconButton type="button" onClick={handleAdd} theme="secondary" disabled={disabled}>
...
export default CartItemSelectorItem;
